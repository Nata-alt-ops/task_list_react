            ...
            <div className="list_con">
                <div className="list">
                    <div className="light_dark">
                        ...
                        className={`theme_icon ${!changeTheme ? 'active': ''}`}
                        onClick={() => setChangeTheme(false)}>
